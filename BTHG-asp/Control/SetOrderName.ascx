<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SetOrderName.ascx.cs" Inherits="Control_SetOrderName" %>
...
<asp:LinkButton ID="lbOrderName" runat="server" Text=""></asp:LinkButton>
